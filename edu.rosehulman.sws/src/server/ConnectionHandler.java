...
//    static void method(long start) {
//        long endTimeMillis = start + 5000;
//        while (true) {
//            // method logic
	...
	public void run() {		
		...
		try {
			...
			try {
				...
				Future<HttpResponse> future = executor.submit(new Task(inStream, this));
		        ...
		        try {
		            ...
		            response = HttpResponseFactory.create408RequestTimeout(Protocol.CLOSE);
		        }
...
//			}
	...
	class Task implements Callable<HttpResponse> {
		 ...
		 */
		public Task(InputStream inStream, ConnectionHandler connectionHandler) {
	    ...
	    public HttpResponse call() throws Exception {
	        return (HttpResponse) this.connHandler.read(inStream);	        
	    }
	}
	...
	public IHttpResponse read(InputStream inputStream) throws Exception {
		...
		try{
			...
			HttpResponseFactory.create408RequestTimeout(Protocol.CLOSE);
		}
